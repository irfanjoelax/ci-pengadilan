                        ...
                        <?php if ($data->status != 'DITOLAK') : ?>
                            <tr>
                                ...
                                <td width="80%">
                                    ...
                                    ?>
                                        <form class="form-inline" action="<?= site_url('ijin_penahanan/update_tujuan/' . $data->id) ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <a href="<?= site_url('ijin_penahanan/berkas_tolak/' . $data->id) ?>" class="btn btn-danger">Tolak Berkas</a>
                                        </form>
                                    <?php
                                    } else {
